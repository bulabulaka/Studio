...
import {roleModel} from '../../../shared/models/view_models/role.model';

export function Get_Roles(currentPage:number,pageSize:number,callback: any) {
...
export function Add_Update_Role(flag: string, role: roleModel, callback: any) {
...
export function Get_Role_Permission_Groups(currentPage:number, pageSize:number,roleId:number, callback: any) {
...
export function Get_Role_Donot_Have_Permission_Groups(roleId:number, callback: any) {
...
export function Add_Role_Permission_Groups(permissionGroupIdArray:string,roleId:number,permissionGroupIdArrayLength:number,operatorId:number, callback: any) {
