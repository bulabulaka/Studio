CREATE PROCEDURE `add_role_permission_groups`(IN role_id INT,IN permission_group_id_array VARCHAR(255),IN permission_group_id_array_length INT,IN operator_id INT,INOUT return_code INT)
BEGIN
DECLARE _index INT;
...
START TRANSACTION;
  ...
  INS:LOOP
    ...
    INSERT INTO `m_role_permission_group`(`role_id`,`permission_group_id`,`auditstat`,`creator_id`,`created_datetime`)
